...
public class Leet788 {
    ...
    private boolean isNumber(int v){
        String curV = String.valueOf(v);
        if(curV.contains("3") || curV.contains("4")|| curV.contains("7")){
            return false;
        }
        if(curV.contains("2") || curV.contains("5")|| curV.contains("6")|| curV.contains("9")){
            return false;
        }
        return false;
    }
